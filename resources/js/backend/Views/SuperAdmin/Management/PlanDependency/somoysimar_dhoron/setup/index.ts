...
const prefix: string = 'সময়সীমার ধরন';
const setup: setup_type = {
    ...
    api_end_point: 'plan-dep-schedule-types',

    module_name: 'schedule_types',
    route_prefix: `schedule_types`,
    store_prefix: 'schedule_types',
    route_path: "schedule-types",
