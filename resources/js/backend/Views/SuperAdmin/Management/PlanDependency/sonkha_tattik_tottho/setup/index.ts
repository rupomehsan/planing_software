...
const prefix: string = 'সংখ্যাতাত্ত্বিক তথ্য';
const setup: setup_type = {
    ...
    api_end_point: 'plan-dep-sonkha-tattik-totthos',

    module_name: 'sonkha_tattik_totthos',
    route_prefix: `sonkha_tattik_totthos`,
    store_prefix: 'sonkha_tattik_totthos',
    route_path: "sonkha-tattik-totthos",
