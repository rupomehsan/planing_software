        ...
        <form @submit.prevent="submitHandler" class="p-2">
            <div class="card w-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <h5 class="text-capitalize"> বিভাগিয় বার্ষিক পরিকল্পনা তৈরি করুন
                    </h5>
                    <div>
                    ...
                    <div class="modal-content border-primary">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-2">
                                        <label for="title ">Sonkha tattik tottho</label>
                                        <input type="text" class="form-control" placeholder="Previous incomplete">
                                    </div>
                                </div>
                                <div class="col-md-12">
