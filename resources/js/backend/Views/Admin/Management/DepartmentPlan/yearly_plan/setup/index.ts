...
const setup: setup_type = {
    ...
    route_path: 'department-yearly-plans',
     ...
     select_fields: ['id','central_yearly_plan_id', 'plan_dep_dofas_id','plan_dep_orjitobbo_target_id','user_depertment_id','title','previous_unfinished_parcent','rating', 'slug', 'created_at', 'status'],
    sort_by_cols: ['id', 'title', 'slug', 'created_at', 'status'],
    table_header_data: ['id', 'central_yearly_plan','plan dofa','orjitobbo target','user_department','title', 'status'],
    table_row_data: ['id','central_yearly_plan','plan_dep_dofa','plan_dep_orjitobbo_target','user_depertment_id', 'title', 'status'],
