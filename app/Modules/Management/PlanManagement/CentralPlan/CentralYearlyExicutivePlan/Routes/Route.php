...
use App\Modules\Management\PlanManagement\CentralPlan\CentralYearlyExicutivePlan\Controller\Controller;
use Illuminate\Support\Facades\Route;

Route::prefix('v1')->group(function () {
    Route::prefix('central-yearly-exicutive-plans')->group(function () {
