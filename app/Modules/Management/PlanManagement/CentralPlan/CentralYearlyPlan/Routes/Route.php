...
use App\Modules\Management\PlanManagement\CentralPlan\CentralYearlyPlan\Controller\Controller;
use Illuminate\Support\Facades\Route;

Route::prefix('v1')->group(function () {
    Route::prefix('central-yearly-plans')->group(function () {
    ...
    Route::post('central-yearly-plan-validation', [Controller::class, 'validation']);
});
