...
{
    /**
     php artisan migrate --path='\App\Modules\Management\PlanManagement\DepartmentPlan\DepartmentYearlyExicutivePlan\Database\create_department_yearly_exicutive_plans_table.php'
     * Run the migrations.
     */
    public function up(): void
    {
        Schema::create('department_yearly_exicutive_plans', function (Blueprint $table) {
            $table->id();
