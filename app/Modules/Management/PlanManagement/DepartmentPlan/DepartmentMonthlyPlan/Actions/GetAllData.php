...
namespace App\Modules\Management\PlanManagement\DepartmentPlan\DepartmentMonthlyPlan\Actions;
        ...
        try {
            ...
            if (request()->has('search') && request()->input('search')) {
                ...
                $data = $data->where(function ($q) use ($searchKey) {
                    $q->where('department_id', 'like', '%' . $searchKey . '%');
                    ...
                    $q->orWhere('month_year', 'like', '%' . $searchKey . '%');
                    ...
                    $q->orWhere('deadline_type', 'like', '%' . $searchKey . '%');
                });
            }
